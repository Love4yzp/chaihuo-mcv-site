...
const home: Record<Locale, Record<string, string>> = {
  zh: {
    ...
    'map.origin': '出发点',
    'journal.title': '行程手账',
    'journal.subtitle': '点击地图上的城市，翻看这一程发生了什么。',
  ...
  en: {
    ...
    'journal.title': 'Trip journal',
    'journal.subtitle': 'Tap a city on the map to read what happened on that leg.',
    ...
    'journal.localConnections': 'Local Connections',
